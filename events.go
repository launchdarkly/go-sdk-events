...
// AliasEvent is generated by calling the client's Alias method.
...
func (f EventFactory) NewAliasEvent(previousKey string, previousKind string,
	currentKey string, currentKind string) AliasEvent {
	return AliasEvent{
		CreationDate: f.timeFn(),
...
// GetCreationDate returns CreationDate
func (evt AliasEvent) GetCreationDate() ldtime.UnixMillisecondTime {
	return evt.CreationDate
}
