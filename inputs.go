...
func (ed EvaluationData) GetBase() BaseEvent {
	return ed.BaseEvent
}

// GetCreationDate returns CreationDate
func (ed EvaluationData) GetCreationDate() ldtime.UnixMillisecondTime {
	return ed.BaseEvent.CreationDate
}
...
// GetBase returns the BaseEvent
func (evt CustomEventData) GetBase() BaseEvent {
	return evt.BaseEvent
}

// GetCreationDate returns CreationDate
func (evt CustomEventData) GetCreationDate() ldtime.UnixMillisecondTime {
...
func (f EventFactory) NewIdentifyEventData(context EventContext) IdentifyEventData {
...
// GetBase returns the BaseEvent
func (evt IdentifyEventData) GetBase() BaseEvent {
	return evt.BaseEvent
}

// GetCreationDate returns CreationDate
func (evt IdentifyEventData) GetCreationDate() ldtime.UnixMillisecondTime {
	return evt.BaseEvent.CreationDate
}
